  ...
  var N = function N() {
    ...
    for (var d = L().decorators, f = {}, e = 0; e < d.length; ++e) {
      ...
      if (h = !c || g.forms) a: {
        h = g.domains;
        var k = a;
        if (h && (g.sameHost || k !== t.location.hostname)) for (var l = 0; l < h.length; l++) {
  ...
  */
  ...
  var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
    ...
    if (a.get(Hd) && (c = be("_ga", !!a.get(cc)), g = be("_gl", !!a.get(cc)), d = De.get(a.get(cc)), e = d._ga, g && 0 < g.indexOf("_ga*") && !e && J(30), g = d.gclid, ca = d._gac, c || e || g || ca)) if (c && e && J(36), a.get(bc) || ye(a.get(Kd))) {
      if (e && (J(38), a.data.set(Q, e), d._gid && (J(51), a.data.set(I, d._gid))), g ? (J(82), a.data.set(ce, g), d.gclsrc && a.data.set(ie, d.gclsrc)) : ca && (d = ca.split(".")) && 2 === d.length && (J(37), a.data.set(ce, d[0]), a.data.set(fe, d[1])), c) b: if (d = c.indexOf("."), -1 == d) J(22);else {
        e = c.substring(0, d);
        g = c.substring(d + 1);
        d = g.indexOf(".");
        c = g.substring(0, d);
